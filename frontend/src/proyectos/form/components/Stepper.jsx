...
export default function Stepper({ currentStep, pasosCompletados = [], goToStep }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5 overflow-x-auto [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar-thumb]:bg-slate-200 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-transparent">
                  ...
                  className={`w-10 h-10 rounded-full flex items-center justify-center text-xs font-bold transition-all
                    ${isCurrent 
                      ...
                      : isCompleted
                        ...
                        : 'bg-slate-100 text-slate-400 group-hover:bg-slate-200' // Incompleto (Gris)
                    }`}
                >
