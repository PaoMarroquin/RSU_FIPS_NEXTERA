...
import { FiSearch, FiBook, FiFileText, FiEye, FiX, FiCalendar, FiUser, FiMapPin, FiAward, FiTarget, FiDollarSign, FiClock, FiCheckCircle } from "react-icons/fi";
...
const Repositorio = () => {
  ...
  // ARREGLO DE PROYECTOS CON ESTADOS DINÁMICOS
  const [proyectosRepositorio, setProyectosRepositorio] = useState([
    {
      ...
      beneficiarios: [1],
      beneficiarios_info: [{ id: 1, codigo: "adulto_mayor", label: "Adultos Mayores (60+ años)" }],
      benef_otro_detalle: "",
      eje_rsu: 1,
      eje_rsu_nombre: "Voluntariado",
      ejes_subitems: [{ id: 1, sub_eje: 4, sub_eje_clave: "V-01", sub_eje_nombre: "Inclusión Digital", detalle: "Capacitación básica" }],
      eje_detalle: "",
      linea_estrategica: 2,
      ...
      actividades: [{ id: 1, nombre: "Taller 01: Configuración segura de Smartphone", descripcion: "Uso seguro de apps.", curso_vinculado: "Interacción Humano Computador", responsable: "Pedro Marroquín", fecha: "2026-04-15", evidencia_esperada: "Fotos del taller y lista de asistencia", orden: 1 }],
      cronograma: [{ id: 1, descripcion: "Convocatoria y registro de participantes", mes_semana: "Semana 1", responsable: "Alumnos asignados", estado_avance: "completado", orden: 1 }],
      ...
      docente_responsable_detalle: { id: 45, nombres: "Pedro", apellidos: "Marroquín", correo_institucional: "pmarroquin@unsa.edu.pe", firma_digital: "" },
      anio_carrera: "4",
      anio_carrera_display: "Cuarto Año",
      es_tesis_quinto_anio: false,
      ods: [4, 10],
      ods_info: [{ id: 4, numero: 4, nombre: "Educación de Calidad" }],
      asignaturas: [{ id: 12, nombre_asignatura: "Interacción Humano Computador", codigo_asignatura: "IHC-202", anio_carrera: "4", semestre: "VII" }],
      docentes_adicionales: [],
      presentado_con_anticipacion: true,
      conclusiones: "El proyecto cubrió satisfactoriamente la brecha inicial.",
      recomendaciones: "Se sugiere extender las horas.",
      lecciones_aprendidas: "El ritmo requiere asistencia uno a uno.",
      medio_difusion: "Portal web UNSA",
      documentos_sustento: [],
    ...
    },
    {
      ...
      departamento_nombre: "Ingeniería de Sistemas e Informática",
      semestre_academico: "2026-I",
      titulo: "Optimización de Procesos de Reciclaje mediante IoT en Socabaya",
      nro_docentes: 1,
      nro_estudiantes: 12,
      lugar_ejecucion: "Socabaya, Arequipa - Puntos Verdes Distritales",
      beneficiarios: [2],
      beneficiarios_info: [{ id: 2, codigo: "comunidad_general", label: "Vecinos de Socabaya" }],
      benef_otro_detalle: "",
      eje_rsu: 2,
      eje_rsu_nombre: "Medio Ambiente",
      ejes_subitems: [],
      eje_detalle: "",
      linea_estrategica: 3,
      linea_estrategica_nombre: "Sostenibilidad y Ecoeficiencia",
      objetivo_institucional: 2,
      objetivo_institucional_nombre: "Promover la conciencia ambiental en el entorno local",
      tipo_actividad: ["proyectos_innovacion"],
      tipo_actividad_display: ["Proyectos de innovación tecnológica"],
      tipo_actividad_otro: "",
      meta_cuantitativa: "Instalar 5 contenedores inteligentes piloto",
      indicador: "Porcentaje de reducción de rebose de residuos",
      fecha_inicio: "2026-08-10",
      fecha_evaluacion_avance: "2026-10-15",
      fecha_termino: "2026-12-18",
      fecha_encuesta_docentes: "2026-12-10",
      fecha_encuesta_alumnos: "2026-12-12",
      fecha_encuesta_grupo_destinatario: "2026-12-15",
      fund_por_que_grupo: "El distrito cuenta con problemas recurrentes de recojo de basura que afectan la salud pública.",
      fund_para_que_proyecto: "Monitorear en tiempo real el llenado para optimizar las rutas de recojo municipal.",
      fund_mecanismo_ensenanza: "Desarrollo tecnológico aplicado e investigación acción.",
      diag_estado_grupo: "Puntos críticos acumulados durante los fines de semana.",
      diag_problemas_detectados: "Falta de coordinación en la recolección logística.",
      diag_aportes_formacion: "Aplicación de redes y sensores IoT en un problema civil real.",
      diag_justificacion_intervencion: "Mitigar focos infecciosos usando tecnología de bajo costo.",
      obj_logro_intervencion: "Proveer data predictiva a la municipalidad.",
      obj_mejora_curricular: "Integrar el diseño de firmware con problemáticas ecológicas.",
      resultado_en_beneficiarios: "En evaluación.",
      resultado_en_curriculo: "En evaluación.",
      impacto_esperado: "Lograr rutas eficientes que bajen en 15% las emisiones de CO2 de los camiones.",
      actividades: [],
      cronograma: [],
      rec_hum_docentes: "1 docente asesor",
      rec_hum_administrativos: "Ninguno",
      rec_hum_estudiantes: "12 estudiantes avanzados",
      rec_hum_egresados: "Ninguno",
      rec_hum_voluntarios: "Ninguno",
      rec_hum_otros: "",
      rec_mat_material_didactico: "Código abierto y esquemáticos",
      rec_mat_afiches: "No aplica",
      rec_mat_equipos: "Placas de desarrollo, sensores ultrasónicos",
      rec_mat_utiles: "Cajas estancas",
      rec_mat_otros: "",
      monto_financiamiento: "15000.00",
      fuente_financiamiento: "autofinanciado",
      fuente_financiamiento_display: "Autofinanciado",
      descripcion_gastos: "Sensores y módulos de transmisión LoraWAN.",
      observaciones_financiamiento: "Pendiente de evaluación de viabilidad.",
      financiamiento_confirmado: false,
      financiamiento_fecha_confirmacion: null,
      periodo: 1,
      periodo_nombre: "AÑO ACADÉMICO 2026 - SEMESTRE I",
      docente_responsable: 71,
      docente_responsable_nombre: "Elena Vizcarra",
      docente_responsable_detalle: { id: 71, nombres: "Elena", apellidos: "Vizcarra", correo_institucional: "evizcarra@unsa.edu.pe", firma_digital: null },
      anio_carrera: "5",
      anio_carrera_display: "Quinto Año",
      es_tesis_quinto_anio: true,
      ods: [11, 13],
      ods_info: [{ id: 11, numero: 11, nombre: "Ciudades Sostenibles" }],
      asignaturas: [],
      docentes_adicionales: [],
      presentado_con_anticipacion: true,
      conclusiones: "",
      ...
      fecha_envio_revision: "2026-06-20",
      fecha_aprobacion: null,
      fecha_inicio_ejecucion: "2026-08-10",
      fecha_cierre: null
    }
  ]);
              ...
              {filteredProyectos.map((proyecto) => (
                <div key={proyecto.id} className={viewMode === 'grid' ? "bg-white rounded-xl border border-slate-200 overflow-hidden flex flex-col justify-between shadow-xs hover:shadow-md transition-shadow" : "bg-white rounded-xl border border-slate-200 p-4 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xs"}>
                  <div className={viewMode === 'grid' ? "w-full" : "flex-1"}>
                    ...
                    <div className={viewMode === 'grid' ? "p-4" : "flex flex-col gap-1"}>
                      <div className="flex flex-wrap items-center gap-1 mb-2">
                        {!viewMode === 'grid' && renderEstadoBadge(proyecto.estado)}
                  ...
                  <div className={viewMode === 'grid' ? "p-4 pt-0 grid grid-cols-2 gap-2" : "flex items-center gap-2 shrink-0"}>
                    <button onClick={() => setViewMode('grid') ? null : setProyectoSeleccionado(proyecto)} className="flex items-center justify-center gap-1.5 h-9 border border-slate-300 rounded-lg text-xs font-semibold text-slate-600 hover:bg-slate-50 transition-colors w-full">
                      <FiEye /> Ver
                    </button>
                    <button 
                      disabled={proyecto.estado !== 'aprobado'} 
                      className={`flex items-center justify-center gap-1.5 h-9 rounded-lg text-xs font-semibold w-full ${proyecto.estado === 'aprobado' ? 'bg-slate-100 text-[#b1122b] hover:bg-red-50' : 'bg-slate-100 text-slate-400 cursor-not-allowed'}`}
                    >
                      <FiFileText /> Informe
                    </button>
                  </div>
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl flex flex-col">
            ...
            <div className="p-6 md:p-8 space-y-8 flex-1">
              ...
              {/* ... El resto de tus bloques de fundamentación y listados se mantienen igual ... */}
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-[11px] text-slate-500">
                  ...
                  <div><b>Envío Revisión:</b> {proyectoSeleccionado.fecha_envio_revision || "No enviado"}</div>
                  <div><b>Aprobación:</b> {proyectoSeleccionado.fecha_aprobacion || "Pendiente"}</div>
                  <div><b>Inicio Ejecución:</b> {proyectoSeleccionado.fecha_inicio_ejecucion || "Pendiente"}</div>
                </div>
              </div>
