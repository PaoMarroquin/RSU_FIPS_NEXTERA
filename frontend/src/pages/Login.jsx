  ...
  return (
    <GoogleOAuthProvider clientId={clientId}>
      <div className="flex min-h-screen w-full bg-slate-50">
        ...
        {/* PANEL IZQUIERDO */}
        {/* 🎨 Cambiado a bg-[#7B1E3A] (Granate UNSA) */}
        <div className="hidden lg:flex lg:w-1/2 bg-[#7B1E3A] relative overflow-hidden flex-col justify-center items-center text-center p-12">
          ...
          <div className="relative z-10 flex flex-col items-center">
            {/* ❌ Se removió por completo el recuadro blanco que contenía el emoji 🎓 */}
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 relative">
          <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-slate-100 p-8 sm:p-10 z-10 relative">
            ...
            {/* 🎨 Ajustado color de texto y fondo del badge al Granate UNSA */}
            ...
            <form className="space-y-5" onSubmit={handleLoginSubmit}>
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center">
                  ...
                  {/* 🎨 Enfoque del input cambiado a focus:ring-[#7B1E3A]/20 y focus:border-[#7B1E3A] */}
                  <input
                    type="email"
                    required
              ...
              <div className="flex items-center justify-between pt-2">
                <label className="flex items-center gap-2 cursor-pointer group">
                  {/* 🎨 Checkbox cambiado a text-[#7B1E3A] y focus:ring-[#7B1E3A] */}
                  <input type="checkbox" className="w-4 h-4 rounded border-slate-300 text-[#7B1E3A] focus:ring-[#7B1E3A]" />
                  <span className="text-sm text-slate-600 group-hover:text-slate-800 transition-colors">Recordarme</span>
                </label>
                {/* 🎨 Enlace cambiado a text-[#7B1E3A] y hover:text-[#5c152a] */}
                <a href="/" className="text-sm font-semibold text-[#7B1E3A] hover:text-[#5c152a] transition-colors">
                  ¿Olvidaste tu contraseña?
                </a>
              </div>

              {/* 🎨 Botón principal cambiado a bg-[#7B1E3A] y hover:bg-[#5c152a] */}
              <button 
                type="submit"
                disabled={loading}
                className="w-full h-11 mt-4 bg-[#7B1E3A] hover:bg-[#5c152a] text-white font-semibold rounded-lg shadow-md shadow-red-950/10 transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
              >
